...
mPP_3x3 = [(dFb_dPhi_e-dFc_dPhi_e)*((rABC*sin60)/inertiePx), (dFb_dTheta_e-dFc_dTheta_e)*((rABC*sin60)/inertiePx), (dFb_dz_e-dFc_dz_e)*((rABC*sin60)/inertiePx);
           (-dFa_dPhi_e+dFb_dPhi_e*cos60+dFc_dPhi_e*cos60)*(rABC/inertiePx), (-dFa_dTheta_e+dFb_dTheta_e*cos60+dFc_dTheta_e*cos60)*(rABC/inertiePx), (-dFa_dz_e + dFb_dz_e*cos60 + dFc_dz_e*cos60)*(rABC/inertiePx);
